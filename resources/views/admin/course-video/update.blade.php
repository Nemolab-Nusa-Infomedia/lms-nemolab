                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="cover-input" id="upload-btn">
                            ...
                            <button type="button" class="btn btn-primary" style="background: 0; border: 1px solid #BDBDBD; color: #414242">Unggah</button>                                    
                        </div>
                    </div>
                    <div class="col-md-12" style="margin-bottom: 0 !important;">
                        ...
                        <div id="tools-popup" class="tools-popup mb-2" style="display: none;">
                            <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch("{{ url('storage/images/covers/' . $course->cover) }}")
                .then(response => {
                    const fileType = response.headers.get('content-type').split('/')[1].toUpperCase();
                ...
                .then(fileInfo => {
                    ...
                    previewImg.style.outline = '2px solid #faa907';
                    previewImg.style.outlineOffset = '2px';
                    previewImg.src = "{{ url('storage/images/covers/' . $course->cover) }}";

                    // Hide SVG and update display
                    svgElement.style.display = 'none';
                    uploadBtnImg.insertBefore(previewImg, uploadBtnImg.firstChild);
                    
                    // Update file info text
                    uploadText[0].textContent = `${fileInfo.type}, ${fileSize} MB`;
                    uploadText[1].style.display = 'none';
                    uploadButton.textContent = 'Hapus';
