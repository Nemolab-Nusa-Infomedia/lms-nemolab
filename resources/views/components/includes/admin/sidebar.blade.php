<div class="col-3 d-none d-lg-block rounded-4 px-0 text-white scroll-sidebar"
    ...
    <a href="{{ route('admin.course') }}" class="list-sidebar {{ request()->is('admin/course') || request()->is('admin/course/create') || request()->is('admin/course/edit') || request()->is('admin/course/*/chapters') || request()->is('admin/course/*/chapter/*/lesson') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.ebook') }}" class="list-sidebar {{ request()->is('admin/ebooks') || request()->is('admin/ebooks/create') || request()->is('admin/ebooks/edit') ? 'active' : '' }}">
