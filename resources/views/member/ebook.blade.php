            ...
            <div class="col-12 text-center justify-content-center">
                ...
                <div class="d-flex align-items-center justify-content-center flex-md-row flex-column"
                    ...
                    <div class="d-flex align-items-center">
                        <img src="{{ url('nemolab/member/img/global.png') }}" alt="" width="18" height="18"
                            class="m-0" />
            ...
            <div class="col-12 rounded-3 position-relative p-0 overflow-hidden" id="ebook" data-pdf="{{ url('storage/file_pdf/' . $ebook->file_ebook) }}">
                ...
                <div class="tools p-4 px-5 w-100 d-flex justify-content-between align-items-center"
                    ...
                    <div class="d-flex zoom">
                        <img src="{{ url('nemolab/member/img/zoomin.png') }}" id="zoom-in" alt=""
                            width="30" />
                        <img src="{{ url('nemolab/member/img/zoomout.png') }}" id="zoom-out" alt=""
                            width="30" class="ms-3" />
                        <img src="{{ url('nemolab/member/img/reset.png') }}" id="reset-zoom" alt="" width="30"
                            class="ms-3" />
                    </div>
                    <div>
                        <span class="page-info text-white">
                            <img src="{{ url('nemolab/member/img/chevron-left-white.png') }}" id="prev-page"
                                alt="" width="20">
                            ...
                            <img class="ms-2" src="{{ url('nemolab/member/img/chevron-right-white.png') }}"
                                id="next-page" alt="" width="20">
                        </span>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="ms-5">
                            <img src="{{ url('nemolab/member/img/fullscreen.png') }}" id="pdf-fullscreen" alt=""
                                width="30" />
                        </div>
                    </div>
                </div>
                ...
                <div class="pdf-height">
                    <div class="pdf-preview d-flex" id="pdf-scrollable-container">
                        <img src="{{ url('nemolab/member/img/loading.gif') }}" id="pdf-loading" class="loading mx-auto" alt="Loading" />
