...
>>>>>>> dev
            ...
            <div class="row align-items-center my-5 mx-md-3">
                <div class="col-xxl-6">
                    <div class="values-grid">
                        ...
                        <div class="value">
                            <div class="icon">
                                <svg width="45" height="35" viewBox="0 0 45 35" fill="none" style="transform: translateY(4px)"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
    ...
    <!-- section 7 -->
    <section class="section-pusat-bantuan mt-md-5" id="section-pusat-bantuan" data-aos="fade-up">
